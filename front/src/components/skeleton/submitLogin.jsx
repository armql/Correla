  ...
  return (
    <div className="parent flex items-center justify-center w-screen h-screen">
      ...
      >
        ...
        <div className="flex flex-col cursor-wait gap-3">
          ...
          <div className="">
            <button
              type="submit"
              disabled
              className="cursor-wait border mt-2 shadow-sm transition duration-200 border-gray-200 px-12 py-2 w-full font-semibold bg-gray-50 hover:bg-sky-100 hover:text-sky-700 hover:border-sky-200"
            >
              Logging in
            </button>
          </div>
